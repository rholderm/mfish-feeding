...
grid.arrange(B5,B6,BG5,BG6,NP5,NP6, ncol=2, left="Daphnia Consumed", top="Effect of Trial Cues")
...
grid.arrange(B7,B8,BG7,BG8,NP7,NP8, ncol=2, left="Daphnia Consumed", top="Effect of Rearing Cues")
...
##############################################################################################################
##############################################################################################################
                           ##### Effect of Trial and Rearing Cues, All Pred regimes #####
##############################################################################################################
##############################################################################################################
...
### Rearing -
inc28<-which(feed.data2$rearing_cue =="-")
feed1<-feed.data2[inc28,]
rm(inc28)

RM<-summarySE(feed1, measurevar="Daphnia", groupvars=c("Sex","trial_cue"))
R1<-ggplot(RM, aes(x=trial_cue,y=Daphnia)) + geom_point(aes(colour = Sex), size=4) +
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  ggtitle("Rearing -") + theme(plot.title = element_text(hjust = 0.5))

RM2<-summarySE(feed1, measurevar="Daphnia", groupvars=("trial_cue"))
R2<-ggplot(RM2, aes(x=trial_cue,y=Daphnia)) + geom_point(size=4) +
  geom_errorbar(aes(ymin=Daphnia-se, ymax=Daphnia+se)) + 
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  ggtitle("Rearing -") + theme(plot.title = element_text(hjust = 0.5))
...
### Rearing +
inc29<-which(feed.data2$rearing_cue =="+")
feed2<-feed.data2[inc29,]
rm(inc29)

RM3<-summarySE(feed2, measurevar="Daphnia", groupvars=c("Sex","trial_cue"))
R3<-ggplot(RM3, aes(x=trial_cue,y=Daphnia)) + geom_point(aes(colour = Sex), size=4) +
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  ggtitle("Rearing +") + theme(plot.title = element_text(hjust = 0.5))

RM4<-summarySE(feed2, measurevar="Daphnia", groupvars=("trial_cue"))
R4<-ggplot(RM4, aes(x=trial_cue,y=Daphnia)) + geom_point(size=4) +
  geom_errorbar(aes(ymin=Daphnia-se, ymax=Daphnia+se)) + 
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  ggtitle("Rearing +") + theme(plot.title = element_text(hjust = 0.5))
...
### Trial NB
inc30<-which(feed.data2$trial_cue =="NB")
feed3<-feed.data2[inc30,]
rm(inc30)

RM5<-summarySE(feed3, measurevar="Daphnia", groupvars=c("Sex","rearing_cue"))
T1<-ggplot(RM5, aes(x=rearing_cue,y=Daphnia)) + geom_point(aes(colour = Sex), size=4) +
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  ggtitle("Trial NB") + theme(plot.title = element_text(hjust = 0.5))

RM6<-summarySE(feed3, measurevar="Daphnia", groupvars=("rearing_cue"))
T2<-ggplot(RM6, aes(x=rearing_cue,y=Daphnia)) + geom_point(size=4) +
  geom_errorbar(aes(ymin=Daphnia-se, ymax=Daphnia+se)) + 
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  ggtitle("Trial NB") + theme(plot.title = element_text(hjust = 0.5))
...
### Trial B
inc31<-which(feed.data2$trial_cue =="B")
feed4<-feed.data2[inc31,]
rm(inc31)

RM7<-summarySE(feed4, measurevar="Daphnia", groupvars=c("Sex","rearing_cue"))
T3<-ggplot(RM7, aes(x=rearing_cue,y=Daphnia)) + geom_point(aes(colour = Sex), size=4) +
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  ggtitle("Trial B") + theme(plot.title = element_text(hjust = 0.5))

RM8<-summarySE(feed4, measurevar="Daphnia", groupvars=("rearing_cue"))
T4<-ggplot(RM8, aes(x=rearing_cue,y=Daphnia)) + geom_point(size=4) +
  geom_errorbar(aes(ymin=Daphnia-se, ymax=Daphnia+se)) + 
  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  ggtitle("Trial B") + theme(plot.title = element_text(hjust = 0.5))


grid.arrange(R1,R2,R3,R4,T1,T2,T3,T4, ncol=2)
